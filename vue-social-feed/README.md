...
You can look at the scaffolding markup provided for the post view by visiting: `http://localhost:5174/posts/1`, and the user profile page by visiting: `http://localhost:5174/users/1`.
